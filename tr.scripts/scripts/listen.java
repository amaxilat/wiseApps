...
//	String localControllerEndpointURL	= "http://" + InetAddress.getLocalHost().getCanonicalHostName() + ":8091/controller";
	String localControllerEndpointURL	= System.getProperty("local.endpoint")+":"+ System.getProperty("local.portlisten");
...
//--------------------------------------------------------------------------
	...
	delegator.publish(localControllerEndpointURL);
        ...
        out = new BufferedWriter(new FileWriter("trace2.out"));
...
button = new JButton("Free listener");
